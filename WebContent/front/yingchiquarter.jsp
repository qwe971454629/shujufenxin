...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
    ...
    <div class="app-body">
        ...
        <main class="main">            
            <!-- Breadcrumb -->
            <ol class="breadcrumb">
                <li class="breadcrumb-item">影驰内存条</li>
                <li class="breadcrumb-item"><a href="yingchiquarter.jsp">季销量</a></li>
            </ol>
    ...
    <script type="text/javascript">
        ...
        require(
            ...
            function (ec) {
                ...
                $.get("${pageContext.request.contextPath}/ycq",function(data,status){
    		
    		data =JSON.parse(data);
    		$.each(data,function(index,p){
    			names.push(p.quarter);
    			datas.push(p.number);
